...
export interface ApiBackgroundBackground extends Schema.SingleType {
  ...
  attributes: {
    home: Attribute.Media & Attribute.Required;
    program: Attribute.Media;
...
export interface ApiHistoryHistory extends Schema.CollectionType {
  ...
  attributes: {
    period: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    aboutUs: Attribute.Text & Attribute.Required;
    description: Attribute.Text;
    title: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiStyleStyle extends Schema.SingleType {
  ...
  attributes: {
    primaryColor: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'#C0351B'>;
    secondPrimaryColor: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'#F78A58'>;
    accentColor: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'#245AA6'>;
    secondAccentColor: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'#739BD2'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::style.style',
...
export interface ApiUnderConstructionUnderConstruction
  extends Schema.SingleType {
  collectionName: 'under_constructions';
  info: {
    singularName: 'under-construction';
    pluralName: 'under-constructions';
